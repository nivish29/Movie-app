...
class KidsPopularRepository {
  BaseApiServices _apiServices = NetworkApiServices();

  Future<dynamic> getkidsPopularList() async {
    try {
      dynamic response =
          await _apiServices.getGetApiResponse(AppUrl.getkidsPopularEndPoint);
      return response = kidsPopularModel.fromJson(response);
    } catch (e) {
      print(e.toString());
    }
  }
